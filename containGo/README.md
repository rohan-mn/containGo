# ContainGo — Interactive SPIFFE Workload Quarantine Lab

> **V7 launcher note:** Existing Deployments created by older ContainGo manifests
> are inspected for immutable selector drift. Only incompatible Deployment
> controllers are recreated; Services, SPIRE state and persistent Control Plane
> storage are preserved. Dashboard health probes use its actual port, 8060.
